...
data0 = [4.47457627118644, 4.593220338983051, 4.610169491525424, 4.271186440677966, 4.2491525423728815]  # 人工
data1 = [4.45, 4.85, 4.65, 4.25, 4.1]
data2 = [4.6, 4.6, 4.5, 4.15, 4.85]  # 大模型
...
ax.set_xticks(index)  # 横坐标标签位于中间柱子的中心
