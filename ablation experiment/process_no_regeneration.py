...
agent_exeGen_generator = ConversableAgent(
...
agent_exeGen_discriminator_1 = ConversableAgent(
    ...
    **Evaluation Process**:
    ...
    4. **Analyze the Knowledge Concept Summary**:
    ...
    5. **Match Exercises to Weak Knowledge concepts**:
    ...
    6. **Identify Missing or Repeated Knowledge Concepts**:
    ...
    7. **Check the Accuracy of Answers**:
    ...
    8. **Evaluate the Logic of Exercises**:
    ...
    9. **Assess the Reasonableness of Exercises**:
...
agent_host = ConversableAgent(
    ...
    4. **Evaluate the Exercises**:
       - Submit the newly generated exercises to the three **exercise evaluation expert(agent_exeGen_discriminator) for review.
    5. **Final Output**:
...
out_groupchat = GroupChat(
    agents=[agent_kt, agent_exeGen_generator, agent_exeGen_discriminator_1, agent_host],
    messages=[],
...
agent_exeGen_discriminator_1.description = "exercise evaluation expert"
