...
def get_prompt(method, student_history):
    if method == "zero_shot":
        return (
            f"You are an expert in generating high-quality multiple-choice exercises for educational purposes.\n"
            f"Your task is to create 10 multiple-choice exercises in Chinese based on the student's performance in answering history exercises.\n"
            ...
            f"2. Provide reasonable and clear options, with at least one correct answer and multiple plausible distractors.\n"
        ...
        return (
            f"You are an expert in generating high-quality multiple-choice exercises for educational purposes.\n"
            f"Your task is to create 10 high-quality multiple-choice Exercises in Chinese based on the student's performance in answering history exercises and the examples I provide for you.\n"
        ...
        return (
            f"You are an expert in generating high-quality multiple-choice exercises for educational purposes.\n"
            f"Your task is to create 10 high-quality multiple-choice exercises in Chinese by following a thought chain based on the student's performance in answering history exercises.\n"
        ...
        return (
            f"You are an expert in generating high-quality multiple-choice exercises for educational purposes.\n"
            f"Your task is to create 10 high-quality multiple-choice exercises in Chinese by following a thought chain and using the examples provided.\n"
            f"Please follow these steps to create the exercises:\n"
            f"1. Analyze the student's performance in answering history exercises:\n"
            f"   - Identify weak aspects to reinforce learning by focusing on knowledge concepts the student answered incorrectly.\n"
...
def save_results_to_file(method, results):
    file_path = "res_Multiple_Choice.txt"
